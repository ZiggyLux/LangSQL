...
<title>Verbes russes - Listes d'un verbe</title>
</head>
<body>
...
/*----------------------------------------------------------------------------*/
function onsup(str) {
	document.formulaire.action = "ruvrbinlist_sup.php";
...
/*----------------------------------------------------------------------------*/
/* Fonction de pickup d'une nouvelle liste pour ce verbe                      */
...
<!----------------------------------------------------------------------------->
<h1>Liste d'un verbe - Gestion</h1>
...
<input type="text" name="ruvrbinlist_cont_txt" id="ruvrbinlist_cont_txt" size="16" maxlength="16"
	   value=""/>
</fieldset></td>
</tr></table>
<?php
	...
	$where_cond = "";
	if (array_key_exists("ruvrbinlist_cont_txt", $_POST) 
		&& strlen(ltrim($_POST['ruvrbinlist_cont_txt'])) > 0)
